      ...
      >
        ...
        <div className="default">
          <div className="form-group">
            <div  className="form-make-halfwidth form-builder-snippet-element" data-initial-constraints="" data-template="default" data-field-name="contacthint">
        ...
        <div className="checkbox-switch">
          <input type="checkbox" id="cb-1003604692" name="formbuilder_5[privacy]" required="required" className="custom-control-input checkbox-switch form-make-fullwidth" data-initial-constraints="not_blank" data-template="default" id="cb-1003604692" value="1" />
          <label className="checkbox-switch-slider" htmlFor="cb-1003604692"></label>
          <label className="custom-control-label checkbox-switch-label" htmlFor="cb-1003604692">
            <div>
              <span className="color-darkgray">
                <span className="text text-xxs">I agree that the data provided by me in the contact form may be used and stored by SCHWIND eye-tech-solutions GmbH to answer my questions and for further communication, in particular also for sending information material and for advertising purposes for medical laser products by e-mail or telephone. I have read the <a href="/en/basics/privacy">data protection</a> declaration and I know that my consent can be withdrawn at any time in the future.</span>
              </span>
            </div>
          </label>
        </div>
